...
contract PaddToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 30000000000000000000000000000 ;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Pad";
    string private _symbol = "PADD";
    ...
    uint256 private _numTokensSellToAddToLiquidity = 20 * 10**6;
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _rOwned[account] = _tOwned[account].sub(
            amount,
            "Error: burn amount exceeds balance"
        );
